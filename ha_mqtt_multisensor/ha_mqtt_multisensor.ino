...
char MQTT_DHT22_TEMPERATURE_SENSOR_TOPIC[sizeof(MQTT_CLIENT_ID) + sizeof(MQTT_SENSOR_TOPIC_TEMPLATE) + sizeof(DHT22_TEMPERATURE_SENSOR_NAME) - 4] = {0};
char MQTT_DHT22_HUMIDITY_SENSOR_TOPIC[sizeof(MQTT_CLIENT_ID) + sizeof(MQTT_SENSOR_TOPIC_TEMPLATE) + sizeof(DHT22_HUMIDITY_SENSOR_NAME) - 4] = {0};
#endif
...
#endif
#if defined(DHT22_SENSOR)
  sprintf(MQTT_DHT22_TEMPERATURE_SENSOR_TOPIC, MQTT_SENSOR_TOPIC_TEMPLATE, MQTT_CLIENT_ID, DHT22_TEMPERATURE_SENSOR_NAME);
  DEBUG_PRINT(F("INFO: MQTT temperature sensor topic: "));
  DEBUG_PRINTLN(MQTT_DHT22_TEMPERATURE_SENSOR_TOPIC);
  sprintf(MQTT_DHT22_HUMIDITY_SENSOR_TOPIC, MQTT_SENSOR_TOPIC_TEMPLATE, MQTT_CLIENT_ID, DHT22_HUMIDITY_SENSOR_NAME);
  DEBUG_PRINT(F("INFO: MQTT humidity sensor topic: "));
  DEBUG_PRINTLN(MQTT_DHT22_HUMIDITY_SENSOR_TOPIC);
#endif
#if defined(BUTTON_SENSOR)
