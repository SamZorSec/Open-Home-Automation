/*
   ...
   Configuration (HA) :
    switch:
      platform: mqtt
      name: 'Office Switch'
      state_topic: 'home/mainswitch/status'
      command_topic: 'home/mainswitch/set'
      retain: true
      optimistic: false
...
const char* WIFI_SSID = "FIBREOP402";
const char* WIFI_PASSWORD = "2312162216";

// MQTT: ID, server IP, port, username and password
const PROGMEM char* MQTT_CLIENT_ID = "office_switch1";
const PROGMEM char* MQTT_SERVER_IP = "192.168.2.20";
const PROGMEM uint16_t MQTT_SERVER_PORT = 1883;
const PROGMEM char* MQTT_USER = "pi";
const PROGMEM char* MQTT_PASSWORD = "aquick1";

// MQTT: topics
const PROGMEM char* MQTT_SWITCH_STATUS_TOPIC = "home/mainswitch/status";
const PROGMEM char* MQTT_SWITCH_COMMAND_TOPIC = "home/mainswitch/set";
